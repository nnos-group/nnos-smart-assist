...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'glow-blue': '0 4px 16px -2px rgba(0, 119, 230, 0.28)',
        'card': '0 4px 14px 0 rgba(15, 23, 42, 0.04), 0 1px 3px 0 rgba(15, 23, 42, 0.02)',
        'subtle': '0 1px 3px 0 rgba(15, 23, 42, 0.04), 0 1px 2px -1px rgba(15, 23, 42, 0.03)',
        'pill-active': '0 2px 8px rgba(15, 23, 42, 0.12)',
