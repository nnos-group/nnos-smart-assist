...
export const MOCK_COMMERCIAL_CAMPAIGNS: CommercialCampaign[] = [
  ...
  },
  {
    ...
    customerMessage: "Instalação técnica oficial gratuita homologada Mopar para este pacote.",
    consultantInstruction: "Ressaltar a economia de mão de obra de oficina especializada (R$ 350 a R$ 600).",
    requiresManagerApproval: false,
    active: true,
  },
  {
    ...
    startDate: "2026-01-01T00:00:00Z",
    endDate: "2026-12-31T23:59:59Z",
    vehicleModels: ["JEEP COMPASS SERIE S", "JEEP COMPASS BLACKHAWK", "JEEP RENEGADE SERIE S"],
    discountType: "fixed",
    discountValue: 500,
    minimumPurchaseValue: 4000,
  ...
  },
  {
    ...
    startDate: "2026-01-01T00:00:00Z",
    endDate: "2026-12-31T23:59:59Z",
    vehicleModels: ["RAM RAMPAGE REBEL", "RAM RAMPAGE LARAMIE"],
    accessoryIds: ["capota"],
    discountType: "fixed",
    discountValue: 350,
    minimumPurchaseValue: 3000,
    stockLimit: 5,
    remainingQuantity: 3,
    customerMessage: "Restam 3 unidades em estoque com valor promocional de lote.",
